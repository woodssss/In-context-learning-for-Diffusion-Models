...
import argparse
from Net.CondUNet import CondUNet
...
if __name__ == "__main__":
    ...
    ### define model
    if flag == 5:
        model = CondUNet(in_ch=3, out_ch= 3, base_ch=128, mul_ls=[1,2,4,8], unet_attn_heads=1, prompt_attn_heads=1).to(device)
    elif flag == 1 or flag == 2 or flag == 3 or flag == 4 or flag == 6:
        model = CondUNet(base_ch=64, mul_ls=[1,2,4,8], unet_attn_heads=1, prompt_attn_heads=1).to(device)
    elif flag == 7:
        model = CondUNet(in_ch=3, out_ch= 3, base_ch=128, mul_ls=[1,2,4,8], unet_attn_heads=1, prompt_attn_heads=1).to(device)


    if flag == 1:
        save_name = 'GRF_cond_Gen_K_' + str(K) + '_B_' + str(B) + '_n_' + str(n) + '_np_' + str(num_prompts)
    elif flag == 2:
        save_name = 'NS_cond_Gen_K_' + str(K) + '_B_' + str(B) + '_n_' + str(n) + '_np_' + str(num_prompts)
    elif flag == 3:
        save_name = 'Era5_cond_Gen_K_' + str(K) + '_B_' + str(B) + '_n_' + str(n) + '_np_' + str(num_prompts)
    elif flag == 4:
        save_name = 'Sketch_cond_Gen_K_' + str(K) + '_B_' + str(B) + '_n_' + str(n) + '_np_' + str(num_prompts)
    elif flag == 5:
        save_name = 'Food_cond_Gen_K_' + str(K) + '_B_' + str(B) + '_n_' + str(n) + '_np_' + str(num_prompts)
    elif flag == 6:
        save_name = 'Dfaust_cond_Gen_K_' + str(K) + '_B_' + str(B) + '_n_' + str(n) + '_np_' + str(num_prompts)
